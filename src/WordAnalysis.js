//from http://smthngsmwhr.wordpress.com/2014/02/02/eloquent-javascript-with-underscore-js/
...
function getListOfUsedWords(text) {
...
function getFrequencyOfWords(words) {
    var frequencies = {},
        currentWord = null;
...
function getSortedListOfWords(wordsFrequencies) {
    var words = [];
...
function getListOfTopTenFrequentWords(wordsFrequencies) {
    var frequencies = [],
        result = [];
